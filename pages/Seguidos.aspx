<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Seguidos.aspx.cs" Inherits="InstagramPF.pages.Seguidos" %>
...
<head runat="server">
    ...
    <style>
      ...
      .seguido-foto-usuario { grid-area: ufoto; }
      .seguido-username { grid-area: usuario; }

      .seguido-grid-container {
        display: grid;
        grid-template-areas:
    ...
    <script type="text/javascript">
        ...
        function clicSeguidos(e) {
            ...
            //document.getElementById("btnLoguearse").Text = e;
            //alert(document.getElementById("HiddenField1").value);
            document.getElementById("btnSeguidos2").click();
        }
        function clicSeguidores(e) {
            ...
            //document.getElementById("btnLoguearse").Text = e;
            //alert(document.getElementById("HiddenField1").value);
            document.getElementById("btnSeguidores2").click();
        }
    </script>
</head>
<body>
    <form id="form1" runat="server">
        ...
        <div id="divPrincipal" runat="server" class="inicio-grid-container">
          <div id="divContenido" runat="server" class="contenido">Contenido
              ...
              <asp:Button id='btnSeguidos2' style='color: #ffff; background-color: #000000; border: none; display:none' runat ='server'  OnClick='clickSeguidos' Text='lola' />
              <asp:Button id='btnSeguidores2' style='color: #ffff; background-color: #000000; border: none; display:none' runat ='server'  OnClick='clickSeguidores' Text='lola' />
          </div>
        </div>
    </form>
</body>
